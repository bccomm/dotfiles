...
* Mail
  #+BEGIN_SRC emacs-lisp
    ...
    (setq mu4e-maildir "/home/sh0e/Mail")
    (setq mail-user-agent 'mu4e-user-agent)

        ;;; That'd be "Elküldött levelek" if offlineimap did proper unicode
    (setq mu4e-drafts-folder "/[Gmail].Piszkozatok")
    (setq mu4e-sent-folder   "/[Gmail].Elk&APw-ld&APY-tt levelek")
    (setq mu4e-trash-folder  "/[Gmail].Kuka")
    ...
    (setq mu4e-maildir-shortcuts
  	'(("/INBOX"             . ?i)
  	  ("/[Gmail].Elk\&APw-ld\&APY-tt\ levelek" . ?s)
  	  ("/[Gmail].Kuka"     . ?t)))

    (setq
     user-mail-address "mano155@gmail.com"
