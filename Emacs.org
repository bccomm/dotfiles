...
* Motivation
  Because I can, and because I want to use Org for, y'know, organizing
  and stuff. My .emacs file has been an ever-growing mess (about 700
  lines), and pulls things in from all kinds of different sources. I
  ended up just copying everything into this file, adding structure as
  I went, and deleted whatever I don't use.
...
(add-to-list 'load-path "~/org-lect/")
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-files (quote ("/home/sh0e/org/" "/home/sh0e/org-lect")))
  (setq org-babel-load-languages (quote ((emacs-lisp . t) (C . t) (python . t))))
...
(define-key org-mode-map "\C-c\\" 'org-lect-update-today)
(define-key org-agenda-mode-map "\C-c\\" 'org-lect-agenda-update-today)
(define-key org-agenda-mode-map "\C-c\C-\\" 'org-lect-needed-effort-today)
